                ...
                <li className="py-3 sm:py-4" key={todo.id}>
                  <div className="flex  items-center space-x-6">
                    ...
                    <button
                      ...
                      disabled={todo.maxbtndisable}
                      onClick={() => handleAddGuest(todo)}
                    >
                      <svg
                    ...
                    <button
                      disabled={todo.minbtndisable}
                      onClick={() => handleRemoveGuest(todo)}
